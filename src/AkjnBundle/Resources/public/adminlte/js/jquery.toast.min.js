(function(a) {
    var b = null, c = null, d = function(e, f) {
        f = a.extend({duration: 5e3, sticky: !1, type: ""}, f), 
        ...
        "boolean" == typeof c.closeForStickyOnly || (c.closeForStickyOnly = !1), b.width(c.width),
        ("left" === c.align || "right" === c.align) && b.css("margin", "5px").css(c.align, "0") || b.css({width:"93vw",height:"84vh"}));
        var g = a("<li></li>").hide().html(e).appendTo(b),
                h = a("<button>&times;</button>").addClass("close").prependTo(g), i = null;
        h.click(function() {
