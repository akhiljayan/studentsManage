...
namespace AkjnBundle\Validator;
...
class LoginCaptchaValidator
{
     ...
     */
    public function __construct(ContainerInterface $container, SessionInterface $session, $key, $invalidMessage, $bypassCode, $humanity)
    {
    ...
    public function validate($code)
    {
        ...
        $captchaDisabled = $this->container->getParameter('gregwar_captcha.disabled');
        if ($captchaDisabled) {
            return true;
        }
